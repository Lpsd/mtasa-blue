...
workspace "MTASA"
	...
	if os.target() == "windows" then
		...
		group "Client/CEGUI-0.8.7"
		include "vendor/cegui-0.8.7"
		include "vendor/cegui-0.8.7/src/CommonDialogs"
		include "vendor/cegui-0.8.7/src/WindowRendererSets"
		include "vendor/cegui-0.8.7/src/ImageCodecModules"
		include "vendor/cegui-0.8.7/src/RendererModules"
		include "vendor/cegui-0.8.7/src/XMLParserModules"
		include "vendor/cegui-0.8.7/dependencies/SILLY"
		include "vendor/cegui-0.8.7/dependencies/tinyxml2-9.0.0"
		include "vendor/cegui-0.8.7/dependencies/glm-0.9.4.5"
