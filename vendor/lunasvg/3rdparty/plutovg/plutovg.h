...
LUNASVG_API plutovg_surface_t* plutovg_surface_create(int width, int height);
LUNASVG_API plutovg_surface_t* plutovg_surface_create_for_data(unsigned char* data, int width, int height, int stride);
LUNASVG_API plutovg_surface_t* plutovg_surface_reference(plutovg_surface_t* surface);
LUNASVG_API void plutovg_surface_destroy(plutovg_surface_t* surface);
LUNASVG_API int plutovg_surface_get_reference_count(const plutovg_surface_t* surface);
LUNASVG_API unsigned char* plutovg_surface_get_data(const plutovg_surface_t* surface);
LUNASVG_API int plutovg_surface_get_width(const plutovg_surface_t* surface);
LUNASVG_API int plutovg_surface_get_height(const plutovg_surface_t* surface);
LUNASVG_API int plutovg_surface_get_stride(const plutovg_surface_t* surface);
LUNASVG_API void plutovg_surface_write_to_png(const plutovg_surface_t* surface, const char* filename);
