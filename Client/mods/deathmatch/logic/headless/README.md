# Client Deathmatch Logic

This directory is the ownership boundary for production logic that can run without launching GTA or loading the Client Deathmatch DLL. Every C++ source below this directory belongs to the `Client Deathmatch Logic` static library.
