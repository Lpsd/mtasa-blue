...
#include "CClientDrawContainerManager.h"
...
public:
    ...
    CClientDrawContainerManager* GetDrawContainerManager() { return m_pDrawContainerManager; }
...
private:
    ...
    CClientDrawContainerManager* m_pDrawContainerManager;
