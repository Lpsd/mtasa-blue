 ...
 *  FILE:        gui/CGUIGridListItem_Impl.h
...
#include <gui/CGUIGridListItem.h>
...
class CGUIGridListItem_Impl : public CGUIGridListItem
{
public:
    enum Type
    {
    ...
    CGUIGridListItem_Impl(CGUI_Impl* pGUI, const char* szText = "", unsigned int uiType = 0, CGUIStaticImage_Impl* pImage = NULL);
    ~CGUIGridListItem_Impl();
